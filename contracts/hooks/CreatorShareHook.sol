 ...
 * @notice Uniswap V4 Hook for Creator Share Token pools (e.g., wsAKITA/ETH)
 * 
 ...
 *      
 *      BUY SURCHARGE: 5.9% (on buys of wsAKITA)
...
contract CreatorShareHook is BaseHook, Ownable {
    ...
    /// @notice Share token (e.g., wsAKITA) - token0 or token1
