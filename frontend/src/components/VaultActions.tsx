          ...
          <div className="space-y-4">
            ...
            {isWhitelisted && (
              <div className="p-3 bg-green-500/10 border border-green-500/30 rounded-lg">
                <p className="text-sm text-green-400 font-medium">Presale Participant - 0% fees</p>
              </div>
            )}
            ...
            {wrapMode === 'wrap' ? (
              <>
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <label className="text-sm text-eagle-gold-light font-medium">vEAGLE Amount</label>
                    <span className="text-sm text-gray-500">
                      Available: {Number(vEagleBalance).toLocaleString(undefined, { maximumFractionDigits: 4 })}
                    </span>
                  </div>
                ...
                <div className="p-4 bg-gray-900/50 rounded-lg border border-gray-700">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-white font-medium">{isWhitelisted ? '0%' : `${Number(depositFee) / 100}%`}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-400">You will receive:</span>
                    <span className="text-eagle-gold-light font-semibold">
                      {wrapAmount ? (
                        isWhitelisted 
                ...
                <p className="text-xs text-gray-500 text-center">
                  EAGLE tokens can be traded on DEXes or bridged cross-chain via LayerZero
                </p>
              </>
            ) : (
              <>
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <label className="text-sm text-eagle-gold-light font-medium">EAGLE Amount</label>
                    <span className="text-sm text-gray-500">
                      Available: {Number(eagleBalance).toLocaleString(undefined, { maximumFractionDigits: 4 })}
                    </span>
                  </div>
                ...
                <div className="p-4 bg-gray-900/50 rounded-lg border border-gray-700">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-white font-medium">{isWhitelisted ? '0%' : `${Number(withdrawFee) / 100}%`}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-400">You will receive:</span>
                    <span className="text-eagle-gold-light font-semibold">
                ...
                <p className="text-xs text-gray-500 text-center">
                  vEAGLE shares continue earning yield in the vault
                </p>
              </>
            )}
          </div>
