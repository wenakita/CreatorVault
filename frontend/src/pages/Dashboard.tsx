    ...
    return (
      <div className="p-4 bg-blue-500/10 border border-blue-500/30">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="font-semibold font-mono text-blue-500 text-xs uppercase tracking-wider">
            CCA Ended
          </span>
        </div>
        ...
        <Link 
          ...
          className="inline-flex items-center gap-1 text-xs text-blue-500 hover:text-blue-500/80 font-mono transition-colors"
        >
  ...
  return (
    <div className="p-4 bg-purple-500/5 border border-purple-500/30">
      <div className="flex items-center gap-2 mb-2">
        ...
        <span className="font-semibold font-mono text-purple-500 text-xs uppercase tracking-wider">
          Active
        </span>
      </div>
    ...
    <div className="relative space-y-8 py-6">
      ...
      >
        <div className="flex items-center justify-between mb-3">
          ...
          <Link to="/launch">
            <button className="bg-blue-500 hover:bg-blue-500/90 text-black px-5 py-2.5 text-sm font-mono uppercase tracking-wider transition-all border border-blue-500/30 flex items-center gap-2">
        ...
        <div className="inline-flex items-center gap-3 px-4 py-3 bg-basalt/50 backdrop-blur-sm border border-basalt-light">
          ...
          <p className="text-slate-400 text-sm font-light">
            New vaults start with a <span className="text-blue-500 font-medium font-mono">7-day CCA launch phase</span>
          </p>
        </div>
      </motion.div>
          ...
          {vaults.map((vault) => (
            <motion.div key={vault.id} variants={item}>
              <Link to={`/vault/${vault.vault}`}>
                <div className="relative bg-basalt/80 backdrop-blur-md border border-basalt-light hover:border-purple-500/30 transition-all duration-300 hover:-translate-y-1 group overflow-hidden shadow-void hover:shadow-glow-mint/20">
                  {/* Top accent line */}
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-end">
                      <div className="flex items-center gap-1 text-blue-500 group-hover:gap-2 transition-all font-mono text-xs uppercase tracking-wider">
