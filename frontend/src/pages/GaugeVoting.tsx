        ...
        <div className="max-w-4xl mx-auto px-6 relative">
          ...
          >
            <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-4 text-center">
              <div className="text-2xl font-bold text-gold-400">69%</div>
              <div className="text-sm text-zinc-500">Jackpot Pool</div>
            </div>
            <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-4 text-center">
              <div className="text-2xl font-bold text-gold-400">21.39%</div>
              <div className="text-sm text-zinc-500">PPS Burn</div>
            </div>
            <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-4 text-center">
              <div className="text-2xl font-bold text-gold-400">9.61%</div>
          ...
          >
            ...
            <div className="grid md:grid-cols-4 gap-4">
              ...
              <div className="text-center">
                <div className="w-10 h-10 rounded-full bg-gold-500/20 text-gold-400 flex items-center justify-center mx-auto mb-2 font-bold">2</div>
              ...
              <div className="text-center">
                <div className="w-10 h-10 rounded-full bg-gold-500/20 text-gold-400 flex items-center justify-center mx-auto mb-2 font-bold">3</div>
              ...
              <div className="text-center">
                <div className="w-10 h-10 rounded-full bg-gold-500/20 text-gold-400 flex items-center justify-center mx-auto mb-2 font-bold">4</div>
          ...
          >
            ...
            <div className="font-mono text-sm bg-zinc-800/50 rounded-lg p-4 overflow-x-auto">
              <div className="text-gold-400">Final Probability = Base × Personal Boost × Vault Weight</div>
            ...
            <div className="mt-4 p-4 bg-amber-500/10 border border-amber-500/30 rounded-lg">
              <div className="text-amber-400 font-medium mb-2">Example</div>
              <div className="text-sm text-zinc-300">
                ...
                <span className="text-gold-400 font-medium">Final: 0.4% × 2.5 × 0.30 = 0.30% probability</span>
              </div>
            </div>
          </motion.div>
        </div>
