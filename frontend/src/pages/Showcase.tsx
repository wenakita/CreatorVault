    ...
    <div className="min-h-screen bg-neo-bg p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Buttons Section */}
          <div className="space-y-6 p-6 rounded-3xl bg-neo-bg shadow-neo-raised">
          ...
          {/* Icon Buttons */}
          <div className="space-y-6 p-6 rounded-3xl bg-neo-bg shadow-neo-raised">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Icon Buttons</h2>
          ...
          {/* Switch/Toggle */}
          <div className="space-y-6 p-6 rounded-3xl bg-neo-bg shadow-neo-raised">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Switch</h2>
            <div className="space-y-4">
              <NeoSwitch 
          ...
          {/* Task Badge */}
          <div className="space-y-6 p-6 rounded-3xl bg-neo-bg shadow-neo-raised">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Task Badge</h2>
          ...
          {/* Slider */}
          <div className="space-y-6 p-6 rounded-3xl bg-neo-bg shadow-neo-raised">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Slider</h2>
          ...
          {/* Menu Icons */}
          <div className="space-y-6 p-6 rounded-3xl bg-neo-bg shadow-neo-raised">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Menu Icons</h2>
            <NeoMenuIcons
          ...
          {/* Status Indicator */}
          <div className="space-y-6 p-6 rounded-3xl bg-neo-bg shadow-neo-raised">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Status Indicator</h2>
            <div className="space-y-4">
              <NeoStatusIndicator
                status="Active"
