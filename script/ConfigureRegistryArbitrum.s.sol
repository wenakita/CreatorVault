...
/**
 * @title ConfigureRegistryArbitrum
 * @notice Configure EagleRegistry on Arbitrum with all chains
 */
contract ConfigureRegistryArbitrum is Script {
    ...
    function run() external {
        console.log("=============================================");
        console.log("CONFIGURE: EagleRegistry on Arbitrum");
        console.log("=============================================");
        console.log("");
        ...
        require(block.chainid == 42161, "Must run on Arbitrum");
